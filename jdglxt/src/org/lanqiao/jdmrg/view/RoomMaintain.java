 ...
 *
 */
public class RoomMaintain extends JPanel implements MouseListener{
	/** 房间楼层 */
	private int row = 6;
	/** 单层房间个数 */
	private int col = 8;
		...
		if("已入住".equals(rb.getRoomState())) {
			...
			jb[0].addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					jf.dispose();
					TestFrame.hidePanelRight(thisP, new RoomMaintain());
			...
			JOptionPane.showMessageDialog(null, "该房间不需要维护！", "提示", JOptionPane.ERROR_MESSAGE);
		}
	}
